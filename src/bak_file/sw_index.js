...
export default createComponent({
  ...
  methods: {
    ...
    initialize: function initialize(active) {
		// console.log('初始化》。。' + this.active + '....' + this.initialSwipe)
      if (active === void 0) {
    ...
    move: function move(_ref2) {
      ...
      if (emitChange && targetActive !== active) {
		  console.log(targetActive + '-----' + active)
		// alert(this.activeIndicator)
        //this.$emit('change', mzzj_activeIndicator >0 ? mzzj_activeIndicator + 1 : this.activeIndicator);
    ...
    genIndicator: function genIndicator() {
      ...
      var count = this.count,
          activeIndicator = mzzj_activeIndicator > 0 ? mzzj_activeIndicator  :this.activeIndicator;
	  mzzj_activeIndicator = this.activeIndicator
  ...
  render: function render() {
	  //console.log(this.trackStyle)
    var h = arguments[0];
    return h("div", {
      "class": bem()
    }, [h("div", {
      "ref": "track",
      //"style": Object.assign(this.trackStyle,{'paddingRight' :'10px','paddingLeft':'10px'}),
